...
# -*- coding: utf-8 -*-
#
# Benchmarks for Hydrologic Timeseries documentation build configuration file, created by
...
version = hydrobm.__version__
# The full version, including alpha/beta/rc tags.
release = hydrobm.__version__
...
latex_documents = [
    (
        master_doc,
        "hydrobm.tex",
        "Benchmarks for Hydrologic Timeseries Documentation",
        "Contributors",
        "manual",
    ),
]
